						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="TotalCost" type="text" placeholder="Enter TotalCost" v-model="reservationToAdd.totalCost"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">End Date</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Total Cost</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="TotalCost" type="text" placeholder="Enter TotalCost" v-model="reservationDetails.totalCost"></input>
																		</div>
						</td>
														</tr>
